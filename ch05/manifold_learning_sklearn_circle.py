...
def main():
    ...
    plot_manifold(X_skernpca, y,get_base_dir('images')+'/kpca_circles.png')
    ...
    plot_manifold(X_lle, y,get_base_dir('images')+'/lle_circles.png')
    ...
    plot_manifold(X_tsne, y, get_base_dir('images')+'/tsne_circles.png')
